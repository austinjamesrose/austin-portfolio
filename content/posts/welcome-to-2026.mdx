...
- this personal site (austinrose.io)
- a fantasy football website for my custom quarterback league (qbleague.xyz)
- a passion project that tracks wait times at Universal Studios Orlando
- a personal app for my family vacation to Disney that planned each day using Anthropic's API based on wait times and location
